...
"""Test for create_bdd100k_tf_record.py."""
...
from object_detection.dataset_tools import create_bdd100k_tf_record


class CreateBdd100kTFRecordTest(tf.test.TestCase):
  ...
  def test_dict_to_tf_example(self):
    ...
    example = create_bdd100k_tf_record.prepare_example(
        save_path,
        annotations,
        label_map_dict)
